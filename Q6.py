...
def sourceIP_cluster(data):
    # Converting data to dataframe object and partitioning into numpy array
...
# Declaring sourceIp and destinationIP clusters from above
...
# Plotting Heatmap depicting conditional probability between sourceIP and destinationIP clusters
